...
public class ItemRegistry {
    ...
    Item obj4 = new Item("4", "Optic Enhancer Implant", "Rare");
    ...
    Item obj9 = new Item("9", "Neural Sync Collar", "Legendary", new HashMap<String, Integer>(Map.of("health", 4, "speed", 4, "strength", 4, "dexterity", 4)));
